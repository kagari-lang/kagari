...
- R04: analysis retains facts and diagnostics; unknown/missing expressions are
  ...
  arguments, contextual generic-call/trait-method argument inference, generic impl specialization
...
- R06: host functions now take a separate declaration containing nominal identity,
  ...
  Format 21/runtime ABI v22 reject prior products; source host index paths are pending.
...
- R07: semantic Struct/Enum/Trait types use DefinitionId, and generic parameters
  ...
  arguments and contextual inference for generic-call and trait-method arguments
