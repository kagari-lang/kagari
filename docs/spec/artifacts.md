...
Format version 22 uses `bincode` with fixed-width integers, little-endian byte order,
...
The runtime ABI identity is `kagari-runtime-abi-v23`; the runtime-helper ABI is
